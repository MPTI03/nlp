...
Pemodelan bahasa adalah tugas memprediksi kata atau karakter berikutnya dalam sebuah dokumen.

\* menunjukkan model yang menggunakan evaluasi dinamis; di mana, pada waktu pengujian, model dapat beradaptasi dengan token yang terlihat untuk meningkatkan kinerja pada token berikut. ([Mikolov et al., (2010)](https://www.fit.vutbr.cz/research/groups/speech/publi/2010/mikolov_interspeech2010_IS100722.pdf), [Krause et al., (2017)](https://arxiv.org/pdf/1709.07432))

## Tingkatan Model Kata

### Penn Treebank

Dataset evaluasi umum untuk pemodelan bahasa pada Penn Treebank, sebagaimana pra-diproses oleh [Mikolov et al., (2011)](https://www.isca-speech.org/archive/archive_papers/interspeech_2011/i11_0605.pdf).
Dataset terdiri dari kata pelatihan 929k, kata validasi 73k, dan kata uji 82k. Sebagai bagian dari pra-pemrosesan, kata-kata menggunakan huruf kecil, angka diganti dengan N, baris baru diganti dengan <eos>, dan semua tanda baca lainnya dihapus. Kosakata adalah kata 10k paling sering dengan sisa token diganti dengan token. Model dievaluasi berdasarkan kebingungan, yang merupakan probabilitas rata-rata per kata log (lebih rendah lebih baik).
...
| Mogrifier LSTM (Melis et al., 2019)                     | 51.4  | 50.1  | 24M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) | |
...
[WikiText-2](https://arxiv.org/abs/1609.07843) telah diusulkan sebagai tolok ukur yang lebih realistis untuk pemodelan bahasa daripada Penn Treebank yang sudah diproses sebelumnya. WikiText-2 terdiri dari sekitar 2 juta kata yang diekstrak dari artikel Wikipedia.
...
| Mogrifier LSTM (Melis et al., 2019)                     | 57.3  | 55.1  | 35M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) | |
...
[WikiText-103](https://arxiv.org/abs/1609.07843) WikiText-103 Korpus WikiText-103 berisi 267.735 kata unik dan setiap kata muncul setidaknya tiga kali dalam set pelatihan.
...
[The One-Billion Word benchmark](https://arxiv.org/pdf/1312.3005.pdf) Benchmark One-Billion Word adalah dataset besar yang berasal dari situs berita-komentar. Dataset terdiri dari 829.250.940 token atas kosakata 793.471 kata. Yang penting, kalimat dalam model ini diacak dan karenanya konteksnya terbatas.
...
## Tingkatan Model Karakter

### Hutter Prize

[Hutter Prize](http://prize.hutter1.net) Wikipedia dataset, dikenal sebagai enwiki8, adalah dataset tingkat byte yang terdiri dari 100 juta byte pertama dari dump XML Wikipedia. Untuk kesederhanaan kami akan menyebutnya sebagai dataset tingkat karakter. Dalam 100 juta byte ini ada 205 token unik.	
...
| Mogrifier LSTM + dynamic eval (Melis et al., 2019)            | 0.988 | 96M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) | |
...
| Mogrifier LSTM (Melis et al., 2019)            | 1.122 | 96M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) |  |
...
### Text8
[Dataset texxt8](http://mattmahoney.net/dc/textdata.html) juga berasal dari teks Wikipedia, tetapi semua XML telah dihapus, dan lebih rendah karena hanya memiliki 26 karakter teks bahasa Inggris ditambah spasi.
...
### Penn Treebank
Kosakata kata-kata dalam dataset tingkat karakter dibatasi hingga 10.000 - kosakata yang sama seperti yang digunakan dalam dataset tingkat kata. Ini sangat menyederhanakan tugas pemodelan bahasa tingkat karakter karena transisi karakter akan terbatas pada yang ditemukan dalam kosakata tingkat kata terbatas.


| Model           | Bit per Character (BPC) |  Number of params | Paper / Source | Code |
| ---------------- | :-----: | :-----: | -------------- | ---- |
| Mogrifier LSTM + dynamic eval (Melis et al., 2019)| 1.083 | 24M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) |  |
| Mogrifier LSTM (Melis et al., 2019)               | 1.120 | 24M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) |  |
...
### Wikipedia Bahasa Multibahasa Corpus

Dataset berbasis karakter[MWC](http://k-kawakami.com/research/mwc) adalah kumpulan halaman Wikipedia yang tersedia dalam sejumlah bahasa. Markup dan karakter langka telah dihapus, tetapi sebaliknya tidak ada preprocessing yang diterapkan.
...
| ------------- | :-----:| :-----: | :-----: | -------------- | ---- |
| Mogrifier LSTM + dynamic eval (Melis et al., 2019)| 1.200 | 1.187 | 24M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) |  |
| Mogrifier LSTM (Melis et al., 2019)               | 1.312 | 1.298 | 24M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) | |
...
| Model           | Validation BPC | Test BPC | Number of params |  Paper / Source | Code |
| ------------- | :-----:| :-----: | :-----: | -------------- | ---- |
| Mogrifier LSTM + dynamic eval (Melis et al., 2019)| 1.202 | 1.191 | 24M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) | |
| Mogrifier LSTM (Melis et al., 2019)               | 1.327 | 1.313 | 24M | [Mogrifier LSTM](http://arxiv.org/abs/1909.01792) | |
